const lang = {
  ...
  'Deactivated.Subtitle': 'tweb supports only one active tab with the app.\nClick anywhere to continue using this tab.',
  'Deactivated.Version.Title': 'WebK has updated...',
  'Deactivated.Version.Subtitle': 'Another tab is running a newer version of tweb.\nClick anywhere to reload this tab.',
  ...
  'Notifications.Default': 'Give tweb permission to send notifications. You may need to refresh the page to see the changes.',
  ...
  'Message.Unsupported.Desktop': '__This message is currently not supported on tweb. Try [getdesktop.telegram.org](https://getdesktop.telegram.org/)__',
  'Message.Unsupported.Mobile': '__This message is currently not supported on tweb. Try [telegram.org/dl](https://telegram.org/dl/)__',
  ...
  'PushNotification.Message.Refreshing': 'tweb is syncing in the background...',
  ...
  'Video.Unsupported.Desktop': '__Unfortunately, this video can\'t be played on tweb. Try opening it with our [desktop app](https://getdesktop.telegram.org/) instead.__',
  'Video.Unsupported.Mobile': '__Unfortunately, this video can\'t be played on tweb. Try opening it with our [mobile app](https://telegram.org/dl/) instead.__',
  ...
  'PasscodeLock.Description': 'When a passcode is set, a lock icon appears above your chat list. Tap it to lock your tweb.',
  ...
  'PasscodeLock.TapToLock': 'Tap to lock tweb.',
